...
export class DashboardComponent implements OnInit {
  ...
  navigateToSocias(): void {
    this.router.navigate(['/admin/socias']); // Ajusta la ruta si es diferente
  }

  navigateToEmpresas(): void {
    this.router.navigate(['/admin/empresa']); // Ajusta la ruta
  }

  navigateToPagos(): void {
    this.router.navigate(['/admin/pagos']); // Ajusta la ruta
  }

  navigateToReportes(): void {
    this.router.navigate(['/reportes']); // Ajusta la ruta
  }
}