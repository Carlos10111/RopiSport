...
/*
        ...
        // ✅ CAMBIO: Usar dateFormatter en lugar de toString()
        if (socia.getFechaInicio() != null) {
            response.setFechaInicio(socia.getFechaInicio().format(dateFormatter));
        }

        if (socia.getFechaBaja() != null) {
            response.setFechaBaja(socia.getFechaBaja().format(dateFormatter));
        }
